...
- Still unverified on a device: that a push actually arrives, that tapping it opens the right session, and whether iOS throttles the silent dismiss push (T18's recorded gap).
